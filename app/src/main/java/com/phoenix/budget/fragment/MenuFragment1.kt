...
class MenuFragment1 : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?,
        ...
        val view = inflater!!.inflate(R.layout.row_menu_item, container, false)
        ...
        if (view is RecyclerView) {
            ...
            view.adapter = MenuRecyclerViewAdapter(DummyContent.ITEMS, mListener)
        }
        return view
    }
    ...
    companion object {
        ...
        fun newInstance(columnCount: Int): MenuFragment1 {
            val fragment = MenuFragment1()
            val args = Bundle()
